...
p. Maven is supported by all major IDEs these days:
   * "IntelliJ IDEA":http://www.jetbrains.com/idea/features/ant_maven.html - Just open the project
   * "NetBeans":http://wiki.netbeans.org/Maven - Just open the project
   * "Eclipse":http://maven.apache.org/eclipse-plugin.html - Download the maven plugin and execute @mvn eclipse:eclipse@