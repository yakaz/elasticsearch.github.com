...
p. Once a "GClient":/guide/clients/groovy-api/client.html has been obtained, all of ElasticSearch APIs can be executed on it. Each Groovy API is exposed using three different mechanisms.
