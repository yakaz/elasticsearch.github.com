...
p. The index API is very similar to the "Java index API":/guide/reference/java-api/index_.html. The Groovy extension to it is the ability to provide the indexed source using a closure. For example:
