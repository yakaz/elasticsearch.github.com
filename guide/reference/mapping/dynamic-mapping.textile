...
p. Default mappings allow to automatically apply generic mapping definition to types that do not have mapping pre defined. This is mainly done thanks to the fact that the "object mapping":/guide/reference/mapping/object-type.html and namely the "root object mapping":/guide/reference/mapping/root-object-type.html allow for schema-less dynamic addition of unmapped fields.
...
p. As an example, here is how we can change the default "date_formats":/guide/reference/mapping/date-format.html used in the root and inner object types:
