...
p. Note, even though the @_id@ is not indexed, all the APIs still work (since they work with the @_uid@ field), as well as fetching by ids using @term@, @term@ or @prefix@ queries / filters (including the specific @ids@ query/filter).
