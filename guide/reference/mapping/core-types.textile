...
p. Posting formats define how fields are stored and represented into memory. Posting formats can be defined per field via the @postings_format@ option. Postings format are configurable since version @0.90.0.Beta1@. Elasticsearch has several builtin formats:
