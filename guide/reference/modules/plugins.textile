...
p. Installing plugins typically take the form of @pluing -install <org>/<user/component>/<version>@. The plugins will be automatically downloaded in this case from @download.elasticsearch.org@, and in case they don't exist there, from maven (central and sonatype).
