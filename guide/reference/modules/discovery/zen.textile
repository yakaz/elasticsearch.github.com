...
p. The zen discovery is integrated with other modules, for example, all communication between nodes is done using the "transport":../transport.html module.
...
p. The unicast discovery uses the "transport":../transport.html module to perform the discovery.
