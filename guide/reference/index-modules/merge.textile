...
p. Since merges can be expensive to perform, especially on low IO environments, they can be throtted using store level throttling. Read the store module documentation on how to set it.
