...
p. The store module allow you to control how index data is stored. It's important to note that the storage is considered temporal only for the shared gateway (non @local@, which is the default).
