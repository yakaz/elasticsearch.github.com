...
p. The store module gives you control how index data is stored. It's important to note that the storage is considered temporal only for the shared gateway (non @local@, which is the default).
