...
p. The @language@ parameter can have the same values as the "snowball filter":snowball-tokenfilter.html and defaults to @English@. Note that only the languages English, Dutch, German, German2 and French have a default set of stopwords provided. 
