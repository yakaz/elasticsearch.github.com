...
p. The @czech@ analyzer is built on top of @standard@ tokenizer, and @standard@, @lowercase@ and @stop@ filters. It comes with default @stopwords@ but they can be set.
