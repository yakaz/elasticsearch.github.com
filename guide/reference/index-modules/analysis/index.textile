...
p. All analyzers, tokenizers, and token filters can be configured with a @version@ parameter to control which Lucene version behavior they should use. Possible values are: @2.9@, @3.0@ and @3.1@.
