...
p. All analyzers, tokenizers, and token filters can be configured with a @version@ parameter to control which Lucene version behavior they should use. Possible values are: @3.0@, @3.1@, @3.2@, @3.3@, @3.4@ and @3.5@ (the highest version number is the default option).
