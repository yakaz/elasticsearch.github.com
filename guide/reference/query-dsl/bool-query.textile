...
p. The bool query also supports @disable_coord@ parameter (defaults to @false@). Basically the coord similarity computes a score factor based on the fraction of all query terms that a document contains. See Lucene @BooleanQuery@ for more details.
