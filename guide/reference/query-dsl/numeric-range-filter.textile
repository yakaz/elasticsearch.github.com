...
p. If caching the *result* of the filter is desired (for example, using the same "teen" filter with ages between 10 and 20), then it is advisable to simply use the "range":/guide/reference/query-dsl/range-filter.html filter.
