...
p. If you don't want the generated individual term queries to be cached, you can use: @bool_nocache@ or @and_nocache@ instead, but be aware that this will affect performance.
