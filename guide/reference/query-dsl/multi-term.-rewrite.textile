...
p. Multi term queries, like "wildcard":wildcard-query.html and "prefix":prefix-query.html are called multi term queries and end up going through a process of rewrite. This also happens on the "query_string":query-string-query.html. All of those queries allow to control how they will get rewritten using the @rewrite@ parameter:
