...
p. Filters documents with fields that have terms within a certain range. Similar to "range query":/guide/reference/query-dsl/range-query.html, except that it acts as a filter. Can be placed within queries that accept a filter.
