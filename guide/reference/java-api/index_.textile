...
p. The source to be indexed is provided as a byte array representing the json to be indexed. It can be easily built using elasticsearch special @XContent@ JSON Builder.
