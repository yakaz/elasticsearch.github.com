...
p. Note that you can add more than one facet. See "Search Java API":search.html for details.
...
p. See "Filters":query-dsl-filters.html to learn how to build filters using Java.
...
p. See "Queries":query-dsl-queries.html to learn how to build queries using Java.
...
p. See documentation on how to build "Filters":query-dsl-filters.html.
