...
ElasticSearch is built using Java, and requires "Java 7":http://java.sun.com/javase/downloads/index.jsp in order to run. The version of Java that will be used can be set by setting the @JAVA_HOME@ environment variable.
