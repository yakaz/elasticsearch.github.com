...
p. Note, versioning are completely real time, and are not affect by the near real time aspect of search operations. If no version is provided, then the operation is forced to be executed without any checks.
