...
p. Automatic index creation can be disabled by setting @action.auto_create_index@ to @false@ in the config file of all nodes. Automatic mapping creation can be disabled by setting @index.mapper.dynamic@ to @false@ in the config files of all nodes.
