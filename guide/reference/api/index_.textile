...
p. If the @timestamp@ value is not provided externally or in the @_source@, the @timestamp@ will be automatically set to the date the document was processed by the indexing chain. More information can be found on the "_timestamp mapping page":../mapping/timestamp-field.html.
...
More information can be found on the "_ttl mapping page":../mapping/ttl-field.html.
