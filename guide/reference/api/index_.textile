...
p. Autoamtic index creation can include a pattern based while/black list, for example, set @action.auto_create_index@ to @+aaa*,-bbb*,+ccc*,-*@ (+ meaning allowed, and - meaning disallowed). Note, this feature is available since 0.20.
