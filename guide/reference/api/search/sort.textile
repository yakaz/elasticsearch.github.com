...
p. From version @0.90.0.Beta1@ Elasticsearch supports sorting by array fields which is also known as multi-valued fields. The @sort_mode@ option
controls what array value is picked for sorting the document it belongs to. The @sort_mode@ has the following option:
...
h2. Sorting within nested objects.
