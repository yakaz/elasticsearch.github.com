...
|q| The query string (maps to the @query_string@ query, see "_Query String Query_":/guide/reference/query-dsl/query-string-query.html for more details). |
