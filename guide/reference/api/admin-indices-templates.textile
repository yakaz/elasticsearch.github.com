...
p. To get list of all index templates you can use "Cluster State":/guide/reference/api/admin-cluster-state.html API and check for the metadata/templates section of the response.
