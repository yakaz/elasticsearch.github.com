...
p. The explain api computes a score explanation for a query and a specific document. This can give useful feedback whether a document matches or didn't match a specific query. This feature is available from version @0.19.9@ and up.
...
h1. All parameters
* @fields@: Allows to control which fields to return as part of the document explained (support @_source@ for the full document). Note, this feature is available since 0.20.
