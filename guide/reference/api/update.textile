...
p. The update operation supports similar parameters are the index API, including:
...
p. It also allows to update the @ttl@ of a document using @ctx._ttl@ and timestamp using @ctx._timestamp@.