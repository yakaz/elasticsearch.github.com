...
p. Each bulk item can include the version value using the @_version@ field. It automatically follows the behavior of the index / delete operation based on the @_version@ mapping.
