...
p. The first command retrieves stats of all the nodes in the cluster. The second commands selectively retrieves nodes stats of only @nodeId1@ and @nodeId2@. All the nodes selective options are explained "here":index.html.
