...
p. The first command retrieves stats of all the nodes in the cluster. The second command selectively retrieves nodes stats of only @nodeId1@ and @nodeId2@. All the nodes selective options are explained "here":/guide/reference/api/index.html.
