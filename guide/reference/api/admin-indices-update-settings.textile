...
p. It is also possible to define a new "analysis":../index-modules/analysis/index.html for the index. But it is required to "close":admin-indices-open-close.html the index first and "open":admin-indices-open-close.html it after the changes are made.
