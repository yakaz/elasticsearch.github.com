...
h1. Updating Index Analysis

p. It is also possible to define a new "analysis":/guide/reference/index-modules/analysis/ for the index. But it is required to "close":/guide/reference/api/admin-indices-open-close.html the index first and "open":/guide/reference/api/admin-indices-open-close.html it after the changes are made.
