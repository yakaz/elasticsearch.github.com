...
p. This section describes the REST APIs *elasticsearch* provides (mainly) using JSON. The API is exposed using "HTTP":/guide/reference/modules/http, "thrift":/guide/reference/modules/thrift, "memcached":/guide/reference/modules/memcached.
