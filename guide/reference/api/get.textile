...
p. The fields will retrieved will either be loaded if they are stored, or fetched from the @_source@ (parsed and extracted). Note, certain "json sub objects" can be returned by explicitly prefixing them with @_source.@, for example: @_source.obj1.obj2@.
