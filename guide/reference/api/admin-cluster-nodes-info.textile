...
p. By default, it just returns the attributes and core settings for a node. It also allows to get information on @settings@, @os@, @process@, @jvm@, @thread_pool@, @network@, @transport@ and @http@:
