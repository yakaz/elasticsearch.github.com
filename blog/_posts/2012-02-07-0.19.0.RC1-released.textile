...
p. The structure of the project has also changed, moving all the plugins to their own repos under "github":http://github.com/elasticsearch/. Installing a plugin now requires specifying the location and version to install it from.
