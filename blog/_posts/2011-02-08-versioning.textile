...
p. What we would get now is a conflict, with the HTTP error code of @407@ and a response:
...
p. Now, we would get an error that the document already exists, with an HTTP response code of @407@.
