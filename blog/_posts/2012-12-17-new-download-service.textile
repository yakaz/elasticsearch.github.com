...
p.  By the end of the week the old assets will be removed, so if you're using any @github.com/downloads/elasticsearch/*@ links in your provisioning system please update them to the commensurate @download.elasticsearch.org/elasticsearch/*@.
